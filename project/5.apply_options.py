...
from tkinter import filedialog  # 서브 모듈이기 때문에 별도로 선언
...
def add_file():
    files = filedialog.askopenfilenames(title= "이미지 파일을 선택하세요", \
                                        ...
                                        initialdir = r"C:\Users\USER\PycharmProjects\tkinter_study\project") # C:/ 보여줌
    # 선택한 파일 목록
    for file in files:
...
btn_add_file = Button(file_frame, text = "파일추가", padx = 5, width = 12, pady = 5, command = add_file)
btn_add_file.pack(side = 'left')

btn_del_file = Button(file_frame, text = '선택삭제', padx = 5, width = 12, pady = 5, command = del_file)
